...
$UnitEntityCopyWith<UnitEntity> get copyWith => _$UnitEntityCopyWithImpl<UnitEntity>(this as UnitEntity, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is UnitEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.updatedBy, updatedBy) || other.updatedBy == updatedBy));
}
...
@override
String toString() {
  return 'UnitEntity(id: $id, companyId: $companyId, name: $name, description: $description, createdAt: $createdAt, updatedAt: $updatedAt, createdBy: $createdBy, updatedBy: $updatedBy)';
}
...
abstract mixin class $UnitEntityCopyWith<$Res>  {
  factory $UnitEntityCopyWith(UnitEntity value, $Res Function(UnitEntity) _then) = _$UnitEntityCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$UnitEntityCopyWithImpl<$Res>
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _UnitEntity value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _UnitEntity value)  $default,){
final _that = this;
switch (_that) {
case _UnitEntity():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _UnitEntity value)?  $default,){
final _that = this;
switch (_that) {
case _UnitEntity() when $default != null:
return $default(_that);case _:
...
class _UnitEntity implements UnitEntity {
  const _UnitEntity({required this.id, required this.companyId, required this.name, required this.description, required this.createdAt, this.updatedAt, this.createdBy, this.updatedBy});
...
@pragma('vm:prefer-inline')
_$UnitEntityCopyWith<_UnitEntity> get copyWith => __$UnitEntityCopyWithImpl<_UnitEntity>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UnitEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.name, name) || other.name == name)&&(identical(other.description, description) || other.description == description)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.updatedBy, updatedBy) || other.updatedBy == updatedBy));
}
...
/// @nodoc
abstract mixin class _$UnitEntityCopyWith<$Res> implements $UnitEntityCopyWith<$Res> {
  factory _$UnitEntityCopyWith(_UnitEntity value, $Res Function(_UnitEntity) _then) = __$UnitEntityCopyWithImpl;
@override @useResult
$Res call({
 String id, int companyId, String name, String description, DateTime createdAt, DateTime? updatedAt, int? createdBy, int? updatedBy
});
...
/// @nodoc
class __$UnitEntityCopyWithImpl<$Res>
    implements _$UnitEntityCopyWith<$Res> {
