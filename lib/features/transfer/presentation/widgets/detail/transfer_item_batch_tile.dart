...
/// Reusable tile that displays a single transfer item batch.
/// Matches the modern theme used in transfer detail sections.
class TransferItemBatchTile extends StatelessWidget {
  final TransferItemBatch batch;

  const TransferItemBatchTile({
    super.key,
    required this.batch,
  });
