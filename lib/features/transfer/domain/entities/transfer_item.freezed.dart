...
mixin _$TransferItem {
 ...
 int get itemId; List<TransferBatch> get batches;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TransferItem&&(identical(other.itemId, itemId) || other.itemId == itemId)&&const DeepCollectionEquality().equals(other.batches, batches));
}
...
@override
String toString() {
  return 'TransferItem(itemId: $itemId, batches: $batches)';
}
...
@useResult
$Res call({
 int itemId, List<TransferBatch> batches
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int itemId,  List<TransferBatch> batches)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TransferItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int itemId,  List<TransferBatch> batches)  $default,) {final _that = this;
switch (_that) {
case _TransferItem():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int itemId,  List<TransferBatch> batches)?  $default,) {final _that = this;
switch (_that) {
case _TransferItem() when $default != null:
return $default(_that.itemId,_that.batches);case _:
  return null;
...
class _TransferItem implements TransferItem {
  const _TransferItem({required this.itemId, required final  List<TransferBatch> batches}): _batches = batches;
  

@override final  int itemId;
 final  List<TransferBatch> _batches;
@override List<TransferBatch> get batches {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TransferItem&&(identical(other.itemId, itemId) || other.itemId == itemId)&&const DeepCollectionEquality().equals(other._batches, _batches));
}
