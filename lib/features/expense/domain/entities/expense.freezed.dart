...
mixin _$Expense {
 ...
 String get id; String get amount; DateTime get expenseDate; String get name; DateTime get createdAt; int? get createdBy;
...
@override
String toString() {
  return 'Expense(id: $id, amount: $amount, expenseDate: $expenseDate, name: $name, createdAt: $createdAt, createdBy: $createdBy)';
}
...
@useResult
$Res call({
 String id, String amount, DateTime expenseDate, String name, DateTime createdAt, int? createdBy
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String amount,  DateTime expenseDate,  String name,  DateTime createdAt,  int? createdBy)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Expense() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String amount,  DateTime expenseDate,  String name,  DateTime createdAt,  int? createdBy)  $default,) {final _that = this;
switch (_that) {
case _Expense():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String amount,  DateTime expenseDate,  String name,  DateTime createdAt,  int? createdBy)?  $default,) {final _that = this;
switch (_that) {
case _Expense() when $default != null:
return $default(_that.id,_that.amount,_that.expenseDate,_that.name,_that.createdAt,_that.createdBy);case _:
  return null;
...
class _Expense implements Expense {
  const _Expense({required this.id, required this.amount, required this.expenseDate, required this.name, required this.createdAt, this.createdBy});
