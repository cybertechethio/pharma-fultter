...
part of 'purchase_item_data_model.dart';
...
/// @nodoc
class _$PurchaseItemDataModelCopyWithImpl<$Res>
    implements $PurchaseItemDataModelCopyWith<$Res> {
  _$PurchaseItemDataModelCopyWithImpl(this._self, this._then);

  final PurchaseItemDataModel _self;
  final $Res Function(PurchaseItemDataModel) _then;
...
/// Adds pattern-matching-related methods to [PurchaseItemDataModel].
extension PurchaseItemDataModelPatterns on PurchaseItemDataModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PurchaseItemDataModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PurchaseItemDataModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PurchaseItemDataModel value)  $default,){
final _that = this;
switch (_that) {
case _PurchaseItemDataModel():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PurchaseItemDataModel value)?  $default,){
final _that = this;
switch (_that) {
case _PurchaseItemDataModel() when $default != null:
return $default(_that);case _:
...
class _PurchaseItemDataModel implements PurchaseItemDataModel {
  const _PurchaseItemDataModel({@JsonKey(fromJson: JsonTypeConverters.intFromDynamic) required this.id, required this.transactionNumber, required this.date, @JsonKey(fromJson: JsonTypeConverters.intFromDynamicNullable) required this.supplierId, required this.supplierName, @JsonKey(fromJson: JsonTypeConverters.intFromDynamic) required this.itemId, required this.itemName, this.itemCode, this.sku, this.category, this.brand, this.imageUrl, @JsonKey(fromJson: JsonTypeConverters.intFromDynamic) required this.quantity, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) required this.unitPrice, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable) this.costPrice, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) required this.subtotal, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) required this.taxAmount, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) required this.totalAmount, this.paymentMethod, @JsonKey(fromJson: JsonTypeConverters.intFromDynamic) required this.branchId, required this.branchName, @JsonKey(fromJson: JsonTypeConverters.intFromDynamic) required this.instockQty});
  factory _PurchaseItemDataModel.fromJson(Map<String, dynamic> json) => _$PurchaseItemDataModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$PurchaseItemDataModelCopyWith<_PurchaseItemDataModel> get copyWith => __$PurchaseItemDataModelCopyWithImpl<_PurchaseItemDataModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$PurchaseItemDataModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PurchaseItemDataModel&&(identical(other.id, id) || other.id == id)&&(identical(other.transactionNumber, transactionNumber) || other.transactionNumber == transactionNumber)&&(identical(other.date, date) || other.date == date)&&(identical(other.supplierId, supplierId) || other.supplierId == supplierId)&&(identical(other.supplierName, supplierName) || other.supplierName == supplierName)&&(identical(other.itemId, itemId) || other.itemId == itemId)&&(identical(other.itemName, itemName) || other.itemName == itemName)&&(identical(other.itemCode, itemCode) || other.itemCode == itemCode)&&(identical(other.sku, sku) || other.sku == sku)&&(identical(other.category, category) || other.category == category)&&(identical(other.brand, brand) || other.brand == brand)&&(identical(other.imageUrl, imageUrl) || other.imageUrl == imageUrl)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.unitPrice, unitPrice) || other.unitPrice == unitPrice)&&(identical(other.costPrice, costPrice) || other.costPrice == costPrice)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&(identical(other.taxAmount, taxAmount) || other.taxAmount == taxAmount)&&(identical(other.totalAmount, totalAmount) || other.totalAmount == totalAmount)&&(identical(other.paymentMethod, paymentMethod) || other.paymentMethod == paymentMethod)&&(identical(other.branchId, branchId) || other.branchId == branchId)&&(identical(other.branchName, branchName) || other.branchName == branchName)&&(identical(other.instockQty, instockQty) || other.instockQty == instockQty));
}
...
/// @nodoc
abstract mixin class _$PurchaseItemDataModelCopyWith<$Res> implements $PurchaseItemDataModelCopyWith<$Res> {
  factory _$PurchaseItemDataModelCopyWith(_PurchaseItemDataModel value, $Res Function(_PurchaseItemDataModel) _then) = __$PurchaseItemDataModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(fromJson: JsonTypeConverters.intFromDynamic) int id, String transactionNumber, DateTime date,@JsonKey(fromJson: JsonTypeConverters.intFromDynamicNullable) int? supplierId, String? supplierName,@JsonKey(fromJson: JsonTypeConverters.intFromDynamic) int itemId, String itemName, String? itemCode, String? sku, String? category, String? brand, String? imageUrl,@JsonKey(fromJson: JsonTypeConverters.intFromDynamic) int quantity,@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double unitPrice,@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable) double? costPrice,@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double subtotal,@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double taxAmount,@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double totalAmount, String? paymentMethod,@JsonKey(fromJson: JsonTypeConverters.intFromDynamic) int branchId, String branchName,@JsonKey(fromJson: JsonTypeConverters.intFromDynamic) int instockQty
});
...
/// @nodoc
class __$PurchaseItemDataModelCopyWithImpl<$Res>
    implements _$PurchaseItemDataModelCopyWith<$Res> {
  __$PurchaseItemDataModelCopyWithImpl(this._self, this._then);

  final _PurchaseItemDataModel _self;
  final $Res Function(_PurchaseItemDataModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? transactionNumber = null,Object? date = null,Object? supplierId = freezed,Object? supplierName = freezed,Object? itemId = null,Object? itemName = null,Object? itemCode = freezed,Object? sku = freezed,Object? category = freezed,Object? brand = freezed,Object? imageUrl = freezed,Object? quantity = null,Object? unitPrice = null,Object? costPrice = freezed,Object? subtotal = null,Object? taxAmount = null,Object? totalAmount = null,Object? paymentMethod = freezed,Object? branchId = null,Object? branchName = null,Object? instockQty = null,}) {
  return _then(_PurchaseItemDataModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,transactionNumber: null == transactionNumber ? _self.transactionNumber : transactionNumber // ignore: cast_nullable_to_non_nullable
as String,date: null == date ? _self.date : date // ignore: cast_nullable_to_non_nullable
as DateTime,supplierId: freezed == supplierId ? _self.supplierId : supplierId // ignore: cast_nullable_to_non_nullable
