...
_PurchaseItemDataModel _$PurchaseItemDataModelFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('_PurchaseItemDataModel', json, ($checkedConvert) {
  final val = _PurchaseItemDataModel(
...
Map<String, dynamic> _$PurchaseItemDataModelToJson(
  _PurchaseItemDataModel instance,
) => <String, dynamic>{
  'id': instance.id,
