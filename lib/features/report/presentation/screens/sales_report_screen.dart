...
import '../providers/sales_report_notifier.dart';
import '../widgets/sales_report/sales_summary_list.dart';
import '../widgets/sales_report/sales_item_list.dart';
import '../widgets/sales_report/sales_report_filter_bottom_sheet.dart';
import '../widgets/sales_report/sales_report_filter_button.dart';
...
class _SalesReportScreenState extends ConsumerState<SalesReportScreen> {
  ...
  void _showFilterBottomSheet() {
    showModalBottomSheet(
      ...
      builder: (context) => SalesReportFilterBottomSheet(
        initialFilter: SalesReportFilter(
  ...
  void _applyFilters() {
    ...
    final notifier = ref.read(
      salesReportProvider(startDate: startDate, endDate: endDate).notifier,
    );
  ...
  Widget build(BuildContext context) {
    ...
    final itemsAsync = ref.watch(
      salesReportProvider(startDate: startDate, endDate: endDate),
    );
    final notifier = ref.read(
      salesReportProvider(startDate: startDate, endDate: endDate).notifier,
    );
            ...
            return RefreshIndicator(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (summary != null) SalesSummaryList(summary: summary),
                  // Period Selector
                  Row(
                    children: [
                      Expanded(
                      ...
                      const SizedBox(width: AppSizes.sm),
                        SalesReportFilterButton(
                          onTap: _showFilterBottomSheet,
                          hasActiveFilters: _customerId != null || _categoryId != null || _status != null,
                        ),
                      const SizedBox(width: AppSizes.sm),
                    ],
                  ),
