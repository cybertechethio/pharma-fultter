...
/// Filter data model for sales report
...
/// Bottom sheet for filtering sales report
class SalesReportFilterBottomSheet extends ConsumerStatefulWidget {
  final SalesReportFilter initialFilter;
  final ValueChanged<SalesReportFilter> onApply;

  const SalesReportFilterBottomSheet({
    super.key,
  ...
  @override
  ConsumerState<SalesReportFilterBottomSheet> createState() =>
      _SalesReportFilterBottomSheetState();
}

class _SalesReportFilterBottomSheetState
    extends ConsumerState<SalesReportFilterBottomSheet> {
  ...
  void _clearFilters() {
    setState(() {
      _filter = const SalesReportFilter();
    });
  }
  ...
  Widget _buildCustomerDropdown(List<SupplierCustomer> customers, AppLocalizations l10n) {
    ...
    return CustomDropdown<int?>(
      value: _filter.customerId,
      items: [
        DropdownItem<int?>(value: null, label: l10n.allCustomers),
        ...dropdownItems,
      ],
      onChanged: (value) {
        setState(() {
          _filter = _filter.copyWith(customerId: value);
        });
      },
      label: l10n.customer,
      hintText: l10n.selectCustomerOptional,
      required: false,
      searchable: true,
      searchHint: l10n.searchCustomers,
    );
  }
          ...
          Flexible(
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  // Customer Filter
                  _buildCustomerDropdown(customers, l10n),
