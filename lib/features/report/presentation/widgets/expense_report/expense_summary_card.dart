...
/// Reusable summary card for expense report metrics
/// Displays: title, value with ETB currency (or count), icon with colored background, colored border
class ExpenseSummaryCard extends StatelessWidget {
  ...
  final bool isCount; // If true, display as count instead of currency
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            isCount
                ? countFormat.format(value.toInt())
