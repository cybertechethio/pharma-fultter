...
mixin _$StockMovement {
 ...
 int get id; int get companyId; int get branchId; int get itemId; int? get transactionId; StockMovementType get type; String get quantity; String? get previousStock; String? get newStock; int? get sourceBranchId; int? get destinationBranchId; int? get transferId; int? get reversesMovementId; String? get notes; StockMovementStatus get status; DateTime get createdAt; DateTime get updatedAt; int? get createdBy; int? get updatedBy; String? get creatorName; String? get updaterName; String? get sourceBranchName; String? get destinationBranchName; StockMovementItem? get item;
...
@useResult
$Res call({
 int id, int companyId, int branchId, int itemId, int? transactionId, StockMovementType type, String quantity, String? previousStock, String? newStock, int? sourceBranchId, int? destinationBranchId, int? transferId, int? reversesMovementId, String? notes, StockMovementStatus status, DateTime createdAt, DateTime updatedAt, int? createdBy, int? updatedBy, String? creatorName, String? updaterName, String? sourceBranchName, String? destinationBranchName, StockMovementItem? item
});


$StockMovementItemCopyWith<$Res>? get item;
...
$StockMovementItemCopyWith<$Res>? get item {
  ...
  return $StockMovementItemCopyWith<$Res>(_self.item!, (value) {
...
class _StockMovement extends StockMovement {
  const _StockMovement({required this.id, required this.companyId, required this.branchId, required this.itemId, this.transactionId, required this.type, required this.quantity, this.previousStock, this.newStock, this.sourceBranchId, this.destinationBranchId, this.transferId, this.reversesMovementId, this.notes, required this.status, required this.createdAt, required this.updatedAt, this.createdBy, this.updatedBy, this.creatorName, this.updaterName, this.sourceBranchName, this.destinationBranchName, this.item}): super._();
...
@override final  StockMovementStatus status;
...
@override final  StockMovementItem? item;
...
@override $StockMovementItemCopyWith<$Res>? get item;
