...
mixin _$ItemModel {
 ...
 int? get companyId; String? get description; String? get imageUrl; String? get sku; String? get barcode; String? get color; String? get size; String? get material;@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable) double? get weight; bool get isTaxable; int get taxRate; bool get isActive;// Pricing fields (mandatory)
@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double get costPrice;@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double get unitPrice;// Date fields
...
@useResult
$Res call({
 int id, String name, String? code, int? companyId, String? description, String? imageUrl, String? sku, String? barcode, String? color, String? size, String? material,@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable) double? weight, bool isTaxable, int taxRate, bool isActive,@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double costPrice,@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double unitPrice, DateTime? expirationDate, DateTime? manufacturingDate, int? categoryId, int? subCategoryId, int? brandId, int? unitId, int? modelId, String? categories, String? subCategories, String? brands, String? units, String? models, String? categoryName, String? subCategoryName, String? brandName, String? unitName, String? modelName, DateTime createdAt, DateTime updatedAt, int? createdBy, int? updatedBy, String? createdByName
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String name,  String? code,  int? companyId,  String? description,  String? imageUrl,  String? sku,  String? barcode,  String? color,  String? size,  String? material, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable)  double? weight,  bool isTaxable,  int taxRate,  bool isActive, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic)  double costPrice, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic)  double unitPrice,  DateTime? expirationDate,  DateTime? manufacturingDate,  int? categoryId,  int? subCategoryId,  int? brandId,  int? unitId,  int? modelId,  String? categories,  String? subCategories,  String? brands,  String? units,  String? models,  String? categoryName,  String? subCategoryName,  String? brandName,  String? unitName,  String? modelName,  DateTime createdAt,  DateTime updatedAt,  int? createdBy,  int? updatedBy,  String? createdByName)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ItemModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String name,  String? code,  int? companyId,  String? description,  String? imageUrl,  String? sku,  String? barcode,  String? color,  String? size,  String? material, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable)  double? weight,  bool isTaxable,  int taxRate,  bool isActive, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic)  double costPrice, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic)  double unitPrice,  DateTime? expirationDate,  DateTime? manufacturingDate,  int? categoryId,  int? subCategoryId,  int? brandId,  int? unitId,  int? modelId,  String? categories,  String? subCategories,  String? brands,  String? units,  String? models,  String? categoryName,  String? subCategoryName,  String? brandName,  String? unitName,  String? modelName,  DateTime createdAt,  DateTime updatedAt,  int? createdBy,  int? updatedBy,  String? createdByName)  $default,) {final _that = this;
switch (_that) {
case _ItemModel():
return $default(_that.id,_that.name,_that.code,_that.companyId,_that.description,_that.imageUrl,_that.sku,_that.barcode,_that.color,_that.size,_that.material,_that.weight,_that.isTaxable,_that.taxRate,_that.isActive,_that.costPrice,_that.unitPrice,_that.expirationDate,_that.manufacturingDate,_that.categoryId,_that.subCategoryId,_that.brandId,_that.unitId,_that.modelId,_that.categories,_that.subCategories,_that.brands,_that.units,_that.models,_that.categoryName,_that.subCategoryName,_that.brandName,_that.unitName,_that.modelName,_that.createdAt,_that.updatedAt,_that.createdBy,_that.updatedBy,_that.createdByName);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String name,  String? code,  int? companyId,  String? description,  String? imageUrl,  String? sku,  String? barcode,  String? color,  String? size,  String? material, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable)  double? weight,  bool isTaxable,  int taxRate,  bool isActive, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic)  double costPrice, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic)  double unitPrice,  DateTime? expirationDate,  DateTime? manufacturingDate,  int? categoryId,  int? subCategoryId,  int? brandId,  int? unitId,  int? modelId,  String? categories,  String? subCategories,  String? brands,  String? units,  String? models,  String? categoryName,  String? subCategoryName,  String? brandName,  String? unitName,  String? modelName,  DateTime createdAt,  DateTime updatedAt,  int? createdBy,  int? updatedBy,  String? createdByName)?  $default,) {final _that = this;
switch (_that) {
case _ItemModel() when $default != null:
return $default(_that.id,_that.name,_that.code,_that.companyId,_that.description,_that.imageUrl,_that.sku,_that.barcode,_that.color,_that.size,_that.material,_that.weight,_that.isTaxable,_that.taxRate,_that.isActive,_that.costPrice,_that.unitPrice,_that.expirationDate,_that.manufacturingDate,_that.categoryId,_that.subCategoryId,_that.brandId,_that.unitId,_that.modelId,_that.categories,_that.subCategories,_that.brands,_that.units,_that.models,_that.categoryName,_that.subCategoryName,_that.brandName,_that.unitName,_that.modelName,_that.createdAt,_that.updatedAt,_that.createdBy,_that.updatedBy,_that.createdByName);case _:
  return null;
...
class _ItemModel implements ItemModel {
  const _ItemModel({required this.id, required this.name, this.code, this.companyId, this.description, this.imageUrl, this.sku, this.barcode, this.color, this.size, this.material, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable) this.weight, required this.isTaxable, this.taxRate = 0, required this.isActive, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) required this.costPrice, @JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) required this.unitPrice, this.expirationDate, this.manufacturingDate, this.categoryId, this.subCategoryId, this.brandId, this.unitId, this.modelId, this.categories, this.subCategories, this.brands, this.units, this.models, this.categoryName, this.subCategoryName, this.brandName, this.unitName, this.modelName, required this.createdAt, required this.updatedAt, this.createdBy, this.updatedBy, this.createdByName});
...
@override@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamicNullable) final  double? weight;
...
/// Create a copy of ItemModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? code = freezed,Object? companyId = freezed,Object? description = freezed,Object? imageUrl = freezed,Object? sku = freezed,Object? barcode = freezed,Object? color = freezed,Object? size = freezed,Object? material = freezed,Object? weight = freezed,Object? isTaxable = null,Object? taxRate = null,Object? isActive = null,Object? costPrice = null,Object? unitPrice = null,Object? expirationDate = freezed,Object? manufacturingDate = freezed,Object? categoryId = freezed,Object? subCategoryId = freezed,Object? brandId = freezed,Object? unitId = freezed,Object? modelId = freezed,Object? categories = freezed,Object? subCategories = freezed,Object? brands = freezed,Object? units = freezed,Object? models = freezed,Object? categoryName = freezed,Object? subCategoryName = freezed,Object? brandName = freezed,Object? unitName = freezed,Object? modelName = freezed,Object? createdAt = null,Object? updatedAt = null,Object? createdBy = freezed,Object? updatedBy = freezed,Object? createdByName = freezed,}) {
