...
@JsonKey(fromJson: JsonTypeConverters.stringFromDynamic) String get id; String get name; String get code;// Optional fields with defaults where appropriate
 int? get companyId; String? get description; String? get imageUrl; String? get sku; String? get barcode; String? get color; String? get size; String? get material;@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) double get weight; bool get isTaxable; int get taxRate; bool get isActive;// Optional Foreign Keys
 int? get categoryId; int? get subCategoryId; int? get brandId; int? get unitId; int? get modelId;// Optional Display Names (from API response - plural keys)
...
@override@JsonKey(fromJson: JsonTypeConverters.doubleFromDynamic) final  double weight;
