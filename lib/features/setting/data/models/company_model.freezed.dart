...
@JsonKey(fromJson: JsonTypeConverters.stringFromDynamic) String get id; String get name; String? get phone1; String? get phone2; String? get logoUrl; String? get tinNumber; String? get tradeName; String? get city; String? get wereda; bool get autoPrint; DateTime? get defaultStartDate; DateTime get createdAt; DateTime? get updatedAt;
...
@override
String toString() {
  return 'CompanyModel(id: $id, name: $name, phone1: $phone1, phone2: $phone2, logoUrl: $logoUrl, tinNumber: $tinNumber, tradeName: $tradeName, city: $city, wereda: $wereda, autoPrint: $autoPrint, defaultStartDate: $defaultStartDate, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
@JsonKey(fromJson: JsonTypeConverters.stringFromDynamic) String id, String name, String? phone1, String? phone2, String? logoUrl, String? tinNumber, String? tradeName, String? city, String? wereda, bool autoPrint, DateTime? defaultStartDate, DateTime createdAt, DateTime? updatedAt
});
...
class _CompanyModel implements CompanyModel {
  const _CompanyModel({@JsonKey(fromJson: JsonTypeConverters.stringFromDynamic) required this.id, required this.name, this.phone1, this.phone2, this.logoUrl, this.tinNumber, this.tradeName, this.city, this.wereda, this.autoPrint = false, this.defaultStartDate, required this.createdAt, this.updatedAt});
