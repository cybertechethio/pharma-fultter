              ...
              children: [
                Container(
                  ...
                  child: Icon(
                    ...
                    color: hasAttachment ? Theme.of(context).colorScheme.primary : Theme.of(context).colorScheme.onSurfaceVariant,
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        style: Theme.of(context).textTheme.bodyMedium?.copyWith(
                          color: hasAttachment ? Theme.of(context).colorScheme.onSurface : Theme.of(context).colorScheme.onSurfaceVariant,
                          fontWeight: hasAttachment ? FontWeight.w500 : FontWeight.normal,
                        ),
                      ),
                      if (!hasAttachment)
                        Text(
